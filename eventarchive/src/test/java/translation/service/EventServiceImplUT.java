...
class EventServiceImplUT {
    ...
    void createEvent_test_should_return_a_created_event() {
        ...
        when(eventRepositoryMock.save(any())).thenReturn(Mono.just(eventEntity));

        StepVerifier.create(sut.createEvent(eventEntity))
                .consumeNextWith(r -> assertThat(r.getText()).contains("<div class=\"paragraph\">"))
                .verifyComplete();
    }
